...
namespace Movies.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            //LINQ query retrieves all genres from database;
            var movies = from m in db.Movies select m;

            //Declare variable as new List
            ...
            genre.AddRange(genreQuery.Distinct());

            //stores query results in ViewBag object
            ...
            {
                movies = movies.Where(movie => movie.Genre.Equals(movieGenre));
            }
            return View(movies);
        }
